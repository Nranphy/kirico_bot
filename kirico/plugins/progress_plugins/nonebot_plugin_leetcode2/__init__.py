...
__kirico_plugin_name__ = 'leetcode查询帮助~'

__kirico_plugin_author__ = 'Nranphy'

__kirico_plugin_version__ = '1.0.5'

__kirico_plugin_repositorie__ = 'https://github.com/Nranphy/nonebot_plugin_leetcode2'

__kirico_plugin_description__ = '今天有好好刷题吗~'

__kirico_plugin_usage__ = '''
每日定时发送leetcode每日一题，和雾子一起做每天刷1000题的人吧！！
还可以通过【/lc | /lc每日】指令来获得每日一题哦
搜索题目请用【/lc查找 xxx】~根据题号或关键词返回最相似的一题√
